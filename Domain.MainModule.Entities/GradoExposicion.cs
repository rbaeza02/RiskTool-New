...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class GradoExposicion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int GradoExposicionID
        {
            ...
            set
            {
                if (_gradoExposicionID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'GradoExposicionID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _gradoExposicionID;
        ...
        private void Fixupbk_te_CotizacionUbicacion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.bk_tc_GradoExposicion = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_GradoExposicion, this))
                    {
                        item.bk_tc_GradoExposicion = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
