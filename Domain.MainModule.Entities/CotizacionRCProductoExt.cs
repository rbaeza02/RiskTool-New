...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCProductoExt: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> RCActInmLimAgregadoID
        {
            get { return _rCActInmLimAgregadoID; }
            set
            {
                if (_rCActInmLimAgregadoID != value)
                {
                    _rCActInmLimAgregadoID = value;
                    OnPropertyChanged("RCActInmLimAgregadoID");
                }
            }
        }
        private Nullable<int> _rCActInmLimAgregadoID;
    
        [DataMember]
        public Nullable<int> RCProdLimAgregadoID
        {
            get { return _rCProdLimAgregadoID; }
            set
            {
                if (_rCProdLimAgregadoID != value)
                {
                    _rCProdLimAgregadoID = value;
                    OnPropertyChanged("RCProdLimAgregadoID");
                }
            }
        }
        private Nullable<int> _rCProdLimAgregadoID;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCProductoExt, this))
            {
                previousValue.bk_te_CotizacionRCProductoExt = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCProductoExt = this;
