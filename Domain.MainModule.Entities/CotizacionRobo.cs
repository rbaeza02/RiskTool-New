...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRobo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int RoboAlarmaID
        {
            get { return _roboAlarmaID; }
            set
            {
                if (_roboAlarmaID != value)
                {
                    _roboAlarmaID = value;
                    OnPropertyChanged("RoboAlarmaID");
                }
            }
        }
        private int _roboAlarmaID;
    
        [DataMember]
        public int RoboPoliciaID
        {
            get { return _roboPoliciaID; }
            set
            {
                if (_roboPoliciaID != value)
                {
                    _roboPoliciaID = value;
                    OnPropertyChanged("RoboPoliciaID");
                }
            }
        }
        private int _roboPoliciaID;
    
        [DataMember]
        public int RoboCircuitoID
        {
            get { return _roboCircuitoID; }
            set
            {
                if (_roboCircuitoID != value)
                {
                    _roboCircuitoID = value;
                    OnPropertyChanged("RoboCircuitoID");
                }
            }
        }
        private int _roboCircuitoID;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRobo, this))
            {
                previousValue.bk_te_CotizacionRobo = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRobo = this;
