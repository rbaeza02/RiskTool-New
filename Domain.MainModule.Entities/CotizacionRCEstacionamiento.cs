...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCEstacionamiento: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> nroCajones
        {
            get { return _nroCajones; }
            set
            {
                if (_nroCajones != value)
                {
                    _nroCajones = value;
                    OnPropertyChanged("nroCajones");
                }
            }
        }
        private Nullable<int> _nroCajones;
    
        [DataMember]
        public Nullable<double> Limite_cajon
        {
            get { return _limite_cajon; }
            set
            {
                if (_limite_cajon != value)
                {
                    _limite_cajon = value;
                    OnPropertyChanged("Limite_cajon");
                }
            }
        }
        private Nullable<double> _limite_cajon;
        ...
        [DataMember]
        public Nullable<bool> isValetParking
        {
            get { return _isValetParking; }
            set
            {
                if (_isValetParking != value)
                {
                    _isValetParking = value;
                    OnPropertyChanged("isValetParking");
                }
            }
        }
        private Nullable<bool> _isValetParking;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCEstacionamiento, this))
            {
                previousValue.bk_te_CotizacionRCEstacionamiento = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCEstacionamiento = this;
