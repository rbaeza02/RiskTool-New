...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRotMaqPC: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int RotMaqMantID
        {
            get { return _rotMaqMantID; }
            set
            {
                if (_rotMaqMantID != value)
                {
                    _rotMaqMantID = value;
                    OnPropertyChanged("RotMaqMantID");
                }
            }
        }
        private int _rotMaqMantID;
    
        [DataMember]
        public int RotMaqGiroID
        {
        ...
        private int _rotMaqGiroID;
    
        [DataMember]
        public int EquipoAuxiliar
        {
            get { return _equipoAuxiliar; }
            set
            {
                if (_equipoAuxiliar != value)
                {
                    _equipoAuxiliar = value;
                    OnPropertyChanged("EquipoAuxiliar");
                }
            }
        }
        private int _equipoAuxiliar;
    
        [DataMember]
        public int RotMaqPCEqRptoID
        {
            get { return _rotMaqPCEqRptoID; }
            set
            {
                if (_rotMaqPCEqRptoID != value)
                {
                    _rotMaqPCEqRptoID = value;
                    OnPropertyChanged("RotMaqPCEqRptoID");
                }
            }
        }
        private int _rotMaqPCEqRptoID;
    
        [DataMember]
        public int RotMaqPCRefCriticasID
        {
            get { return _rotMaqPCRefCriticasID; }
            set
            {
                if (_rotMaqPCRefCriticasID != value)
                {
                    _rotMaqPCRefCriticasID = value;
                    OnPropertyChanged("RotMaqPCRefCriticasID");
                }
            }
        }
        private int _rotMaqPCRefCriticasID;
    
        [DataMember]
        public int RotMaqPCDeducibleID
        {
            get { return _rotMaqPCDeducibleID; }
            set
            {
                if (_rotMaqPCDeducibleID != value)
                {
                    _rotMaqPCDeducibleID = value;
                    OnPropertyChanged("RotMaqPCDeducibleID");
                }
            }
        }
        private int _rotMaqPCDeducibleID;
    
        [DataMember]
        public int RotMaqPCPeriodoID
        {
            get { return _rotMaqPCPeriodoID; }
            set
            {
                if (_rotMaqPCPeriodoID != value)
                {
                    _rotMaqPCPeriodoID = value;
                    OnPropertyChanged("RotMaqPCPeriodoID");
                }
            }
        }
        private int _rotMaqPCPeriodoID;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRotMaqPC, this))
            {
                previousValue.bk_te_CotizacionRotMaqPC = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRotMaqPC = this;
