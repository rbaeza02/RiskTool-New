...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionAnuncio: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int nroAnuncios
        {
            get { return _nroAnuncios; }
            set
            {
                if (_nroAnuncios != value)
                {
                    _nroAnuncios = value;
                    OnPropertyChanged("nroAnuncios");
                }
            }
        }
        private int _nroAnuncios;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionAnuncio, this))
            {
                previousValue.bk_te_CotizacionAnuncio = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionAnuncio = this;
