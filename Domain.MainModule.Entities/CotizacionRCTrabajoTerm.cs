...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCTrabajoTerm: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<double> UnionMezcla
        {
            get { return _unionMezcla; }
            set
            {
                if (_unionMezcla != value)
                {
                    _unionMezcla = value;
                    OnPropertyChanged("UnionMezcla");
                }
            }
        }
        private Nullable<double> _unionMezcla;
    
        [DataMember]
        public Nullable<double> VentaAnual
        {
            get { return _ventaAnual; }
            set
            {
                if (_ventaAnual != value)
                {
                    _ventaAnual = value;
                    OnPropertyChanged("VentaAnual");
                }
            }
        }
        private Nullable<double> _ventaAnual;
        ...
        private void Fixupbk_tc_GrupoIncendio(GrupoIncendio previousValue)
        {
            ...
            if (previousValue != null && previousValue.bk_te_CotizacionRCTrabajoTerm.Contains(this))
            {
                previousValue.bk_te_CotizacionRCTrabajoTerm.Remove(this);
            }
    
            if (bk_tc_GrupoIncendio != null)
            {
                if (!bk_tc_GrupoIncendio.bk_te_CotizacionRCTrabajoTerm.Contains(this))
                {
                    bk_tc_GrupoIncendio.bk_te_CotizacionRCTrabajoTerm.Add(this);
                }
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCTrabajoTerm, this))
            {
                previousValue.bk_te_CotizacionRCTrabajoTerm = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCTrabajoTerm = this;
