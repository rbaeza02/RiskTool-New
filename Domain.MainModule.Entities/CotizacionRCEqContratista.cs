...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCEqContratista: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<double> Terceros
        {
            ...
            set
            {
                ...
                {
                    _terceros = value;
                    OnPropertyChanged("Terceros");
                }
            }
        }
        private Nullable<double> _terceros;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCEqContratista, this))
            {
                previousValue.bk_te_CotizacionRCEqContratista = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCEqContratista = this;
