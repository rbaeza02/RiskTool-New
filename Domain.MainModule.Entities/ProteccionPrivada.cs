...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class ProteccionPrivada: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int ProteccionPrivadaID
        {
            ...
            set
            {
                if (_proteccionPrivadaID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ProteccionPrivadaID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _proteccionPrivadaID;
        ...
        private void Fixupbk_te_CotizacionUbicacion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.bk_tc_ProteccionPrivada = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_ProteccionPrivada, this))
                    {
                        item.bk_tc_ProteccionPrivada = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
