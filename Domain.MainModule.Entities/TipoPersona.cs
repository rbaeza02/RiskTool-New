...
namespace Domain.MainModule.Entities
{
    ...
    public partial class TipoPersona: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TipoPersonaID
        {
            ...
            set
            {
                if (_tipoPersonaID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TipoPersonaID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        [DataMember]
        public Nullable<int> SISEcod_TipoPersona
        {
            get { return _sISEcod_TipoPersona; }
            set
            {
                if (_sISEcod_TipoPersona != value)
                {
                    _sISEcod_TipoPersona = value;
                    OnPropertyChanged("SISEcod_TipoPersona");
                }
            }
        }
        private Nullable<int> _sISEcod_TipoPersona;
        ...
        private void Fixupbk_tc_Asegurado(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_TipoPersona, this))
                    {
                        item.bk_tc_TipoPersona = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
