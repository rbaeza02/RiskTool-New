...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCTaller: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<double> RatioPruebas
        {
            get { return _ratioPruebas; }
            set
            {
                if (_ratioPruebas != value)
                {
                    _ratioPruebas = value;
                    OnPropertyChanged("RatioPruebas");
                }
            }
        }
        private Nullable<double> _ratioPruebas;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCTaller, this))
            {
                previousValue.bk_te_CotizacionRCTaller = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCTaller = this;
