...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionEqElecCostoOper: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionEqElecCostoOper, this))
            {
                previousValue.bk_te_CotizacionEqElecCostoOper = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionEqElecCostoOper = this;
