...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionEqElec: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int EqElecRiesgoID
        {
            get { return _eqElecRiesgoID; }
            set
            {
                if (_eqElecRiesgoID != value)
                {
                    _eqElecRiesgoID = value;
                    OnPropertyChanged("EqElecRiesgoID");
                }
            }
        }
        private int _eqElecRiesgoID;
    
        [DataMember]
        public int EqElecIncID
        {
            get { return _eqElecIncID; }
            set
            {
                if (_eqElecIncID != value)
                {
                    _eqElecIncID = value;
                    OnPropertyChanged("EqElecIncID");
                }
            }
        }
        private int _eqElecIncID;
    
        [DataMember]
        public int EqElecGiroID
        {
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionEqElec, this))
            {
                previousValue.bk_te_CotizacionEqElec = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionEqElec = this;
