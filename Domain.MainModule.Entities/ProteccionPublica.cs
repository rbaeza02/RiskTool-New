...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class ProteccionPublica: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int ProteccionPublicaID
        {
            ...
            set
            {
                if (_proteccionPublicaID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ProteccionPublicaID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _proteccionPublicaID;
        ...
        private void Fixupbk_te_CotizacionUbicacion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.bk_tc_ProteccionPublica = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_ProteccionPublica, this))
                    {
                        item.bk_tc_ProteccionPublica = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
