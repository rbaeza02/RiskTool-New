...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class IncGeneralInf: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_IncGeneralInf, this))
            {
                previousValue.bk_te_IncGeneralInf = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_IncGeneralInf = this;
