...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionEqElecPortExt: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionEqElecPortExt, this))
            {
                previousValue.bk_te_CotizacionEqElecPortExt = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionEqElecPortExt = this;
