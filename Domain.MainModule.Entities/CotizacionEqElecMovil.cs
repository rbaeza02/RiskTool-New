...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionEqElecMovil: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private int _eqElecMovilTipoID;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionEqElecMovil, this))
            {
                previousValue.bk_te_CotizacionEqElecMovil = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionEqElecMovil = this;
