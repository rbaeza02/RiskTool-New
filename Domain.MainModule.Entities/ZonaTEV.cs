...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class ZonaTEV: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ZonaTEVID
        {
            ...
            set
            {
                if (_zonaTEVID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ZonaTEVID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _zonaTEVID = value;
        ...
        [DataMember]
        public Nullable<int> SISEzona_amis_terremoto
        {
            get { return _sISEzona_amis_terremoto; }
            set
            {
                if (_sISEzona_amis_terremoto != value)
                {
                    _sISEzona_amis_terremoto = value;
                    OnPropertyChanged("SISEzona_amis_terremoto");
                }
            }
        }
        private Nullable<int> _sISEzona_amis_terremoto;
        ...
        private void Fixupbk_tc_Ubicacion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_ZonaTEV, this))
                    {
                        item.bk_tc_ZonaTEV = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
