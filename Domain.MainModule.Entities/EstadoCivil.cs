...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class EstadoCivil: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int EstadoCivilID
        {
            ...
            set
            {
                if (_estadoCivilID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'EstadoCivilID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        [DataMember]
        public Nullable<int> SISEcod_est_civil
        {
            get { return _sISEcod_est_civil; }
            set
            {
                if (_sISEcod_est_civil != value)
                {
                    _sISEcod_est_civil = value;
                    OnPropertyChanged("SISEcod_est_civil");
                }
            }
        }
        private Nullable<int> _sISEcod_est_civil;
        ...
        private void Fixupbk_tc_Asegurado(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_EstadoCivil, this))
                    {
                        item.bk_tc_EstadoCivil = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
