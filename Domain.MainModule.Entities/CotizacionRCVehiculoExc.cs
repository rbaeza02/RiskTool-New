...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionRCVehiculoExc: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public Nullable<double> Exceso
        {
            ...
            set
            {
                ...
                {
                    _exceso = value;
                    OnPropertyChanged("Exceso");
                }
            }
        }
        private Nullable<double> _exceso;
    
        [DataMember]
        public Nullable<int> nroVehiculoAB
        {
            get { return _nroVehiculoAB; }
            set
            {
                if (_nroVehiculoAB != value)
                {
                    _nroVehiculoAB = value;
                    OnPropertyChanged("nroVehiculoAB");
                }
            }
        }
        private Nullable<int> _nroVehiculoAB;
    
        [DataMember]
        public Nullable<int> nroVehiculoC
        {
            get { return _nroVehiculoC; }
            set
            {
                if (_nroVehiculoC != value)
                {
                    _nroVehiculoC = value;
                    OnPropertyChanged("nroVehiculoC");
                }
            }
        }
        private Nullable<int> _nroVehiculoC;
    
        [DataMember]
        public Nullable<bool> isContaminacionC
        {
            get { return _isContaminacionC; }
            set
            {
                if (_isContaminacionC != value)
                {
                    _isContaminacionC = value;
                    OnPropertyChanged("isContaminacionC");
                }
            }
        }
        private Nullable<bool> _isContaminacionC;
    
        [DataMember]
        public Nullable<double> Ocupantes
        {
            ...
            set
            {
                ...
                {
                    _ocupantes = value;
                    OnPropertyChanged("Ocupantes");
                }
            }
        }
        private Nullable<double> _ocupantes;
    
        [DataMember]
        public Nullable<double> DañoAB
        {
            get { return _dañoAB; }
            set
            {
                ...
                {
                    _dañoAB = value;
                    OnPropertyChanged("DañoAB");
                }
            }
        }
        private Nullable<double> _dañoAB;
    
        [DataMember]
        public Nullable<double> ContaminacionAB
        {
            get { return _contaminacionAB; }
            set
            {
                if (_contaminacionAB != value)
                {
                    _contaminacionAB = value;
                    OnPropertyChanged("ContaminacionAB");
                }
            }
        }
        private Nullable<double> _contaminacionAB;
        ...
        [DataMember]
        public Nullable<double> PrimaAB
        {
            get { return _primaAB; }
            set
            {
                ...
                {
                    _primaAB = value;
                    OnPropertyChanged("PrimaAB");
                }
            }
        }
        private Nullable<double> _primaAB;
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionRCVehiculoExc, this))
            {
                previousValue.bk_te_CotizacionRCVehiculoExc = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionRCVehiculoExc = this;
