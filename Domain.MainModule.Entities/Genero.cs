...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class Genero: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int GeneroID
        {
            ...
            set
            {
                if (_generoID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'GeneroID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _generoID = value;
        ...
        [DataMember]
        public string SISEcod_sexo
        {
            get { return _sISEcod_sexo; }
            set
            {
                if (_sISEcod_sexo != value)
                {
                    _sISEcod_sexo = value;
                    OnPropertyChanged("SISEcod_sexo");
                }
            }
        }
        private string _sISEcod_sexo;
        ...
        private void Fixupbk_tc_Asegurado(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.bk_tc_Genero, this))
                    {
                        item.bk_tc_Genero = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
