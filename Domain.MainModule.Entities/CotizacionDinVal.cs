...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionDinVal: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int DinValCilindroID
        {
            get { return _dinValCilindroID; }
            set
            {
                if (_dinValCilindroID != value)
                {
                    _dinValCilindroID = value;
                    OnPropertyChanged("DinValCilindroID");
                }
            }
        }
        private int _dinValCilindroID;
    
        [DataMember]
        public int DinValTipoAlarmaID
        {
            get { return _dinValTipoAlarmaID; }
            set
            {
                if (_dinValTipoAlarmaID != value)
                {
                    _dinValTipoAlarmaID = value;
                    OnPropertyChanged("DinValTipoAlarmaID");
                }
            }
        }
        private int _dinValTipoAlarmaID;
    
        [DataMember]
        public int DinValPoliciaID
        {
            get { return _dinValPoliciaID; }
            set
            {
                if (_dinValPoliciaID != value)
                {
                    _dinValPoliciaID = value;
                    OnPropertyChanged("DinValPoliciaID");
                }
            }
        }
        private int _dinValPoliciaID;
    
        [DataMember]
        public int DinValGiroID
        {
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.bk_te_CotizacionDinVal, this))
            {
                previousValue.bk_te_CotizacionDinVal = null;
            }
    
            if (bk_te_Cotizacion != null)
            {
                bk_te_Cotizacion.bk_te_CotizacionDinVal = this;
