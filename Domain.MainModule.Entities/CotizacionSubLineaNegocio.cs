...
namespace Domain.MainModule.Entities
{
    ...
    #endif
    public partial class CotizacionSubLineaNegocio: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void Fixupbk_tc_SubLineaNegocio(SubLineaNegocio previousValue)
        {
            ...
            if (previousValue != null && previousValue.bk_tr_CotizacionSubLineaNegocio.Contains(this))
            {
                previousValue.bk_tr_CotizacionSubLineaNegocio.Remove(this);
            }
    
            if (bk_tc_SubLineaNegocio != null)
            {
                if (!bk_tc_SubLineaNegocio.bk_tr_CotizacionSubLineaNegocio.Contains(this))
                {
                    bk_tc_SubLineaNegocio.bk_tr_CotizacionSubLineaNegocio.Add(this);
                }
        ...
        private void Fixupbk_te_Cotizacion(Cotizacion previousValue)
        {
            ...
            {
                if (!bk_te_Cotizacion.bk_tr_CotizacionSubLineaNegocio.Contains(this))
                {
                    bk_te_Cotizacion.bk_tr_CotizacionSubLineaNegocio.Add(this);
                }
