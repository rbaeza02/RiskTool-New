    ...
    <script runat="server">
        void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/PresentacionCotizacionRC.rdlc");
                ReportViewer1.LocalReport.DataSources.Clear();
                ...
                ReportDataSource rdc3 = new ReportDataSource("dsTexto", Model.TextosRC);
                ReportDataSource rdc4 = new ReportDataSource("dsCabeceraRC", Model.DatosGeneralesRC);
                ReportViewer1.LocalReport.DataSources.Add(rdc);
